...
export default [
  ...
  },
  {
    ...
    description:
      'container-background-color attribute: `container-background-color=""`',
    els: [
      "mj-accordion",
      "mj-button",
      "mj-divider",
  ...
  },
  {
    ...
    description:
      'inner-background-color attribute: `inner-background-color=""`',
    els: ["mj-column"],
  },
  {
    prefix: "inner-border",
  ...
  },
  {
    ...
    description:
      'tb-selected-border-color attribute: `tb-selected-border-color=""`',
    els: ["mj-carousel"],
  },
  {
    prefix: "tb-width",
